...
## 文件上传
```
obsutil cp ckpt-2019-08-21_11_53-GPU1-Epoch_021-acc_0.99770-val_acc_0.91717.h5 obs://yml-hw201908/weights/
```
## 登录服务器
```
ssh -oPort=6022 yangjin@119.3.171.78
```
## 进入docker
```
...
### baseline
Xception => val_acc = 0.89885

### baseline-NASNetLarge
NASNetLarge => val_acc = 0.91717

### baseline-ResNeXt50
ResNeXt50 => val_acc = 0.89568

### baseline-InceptionResNetV2
InceptionResNetV2 => val_acc = 0.90699
